<?php
	...
	$return = "";
	$i = 0;
	$result = $database->db_query("SELECT u.name, u.userID, u.sex, uc.comment, uc.dateSubmitted FROM Users as u JOIN Users_Comments as uc ON uc.userID = u.userID WHERE uc.userID = $userID ORDER BY uc.dateSubmitted DESC LIMIT $startRow, ".COMMENTS_PER_PAGE);
