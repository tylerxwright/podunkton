<?php
	...
	$return .= "<tr><td colspan='2' style='border-bottom: solid 1px #333; color: #fff; background-color: #647DB8;'><b>Item Name:".$row->name."</b> ".$row->itemID." </td></tr>";
	...
	$return .= "<tr><td>Starter: </td><td>".$row->defaultEquip."</td></tr>";
